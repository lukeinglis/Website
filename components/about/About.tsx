  ...
  return (
    <section id="about" className="px-6 py-24">
      <div className="mx-auto max-w-3xl">
        ...
        >
          <p>
            I&apos;m a software engineer who builds tools and systems that make
            complex work simpler. With experience spanning full-stack
            development, cloud infrastructure, and developer tooling, I focus on
            shipping software that&apos;s reliable, maintainable, and genuinely
            useful.
          </p>
          <p>
            ...
            the best code is the code you don&apos;t have to think twice about.
          </p>
          <p>
            When I&apos;m not writing code, you&apos;ll find me exploring new
            technologies, contributing to open source, and thinking about how to
            make developer experiences better.
          </p>
        </div>
        <div className="mt-12">
          <h3
